...
def build_test_dataset(data_config):
    ...
    if mode == "repr_ed_field":
        ...
        test_dataset =  QMugsPointCloudDataset(pkl_path=pkl_path, split='test', grid_size=grid_size, targets=targets)
        ...
        test_dataset = QMugsDenseDataset(pkl_path=pkl_path, split='test', grid_size=grid_size, targets=targets)
        return test_dataset, qmugs_dense_collate_fn
